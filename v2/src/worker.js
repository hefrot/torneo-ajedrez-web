...
import {syncAcademicRatings} from './rating-tracking.js';
...
const jobs={
  async refreshAcademicRatings(){return syncAcademicRatings(db,{lichessClient:lichess,chessComClient:chesscom,now});},
