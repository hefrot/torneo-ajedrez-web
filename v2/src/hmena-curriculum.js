...
const legacyMap={
  'SEEDS-L1':['FND-BOARD','FND-PAWNS'],'SEEDS-L2':['FND-PIECES'],'SEEDS-L3':['FND-PIECES'],'SEEDS-L4':['FND-PIECES'],'SEEDS-L5':['FND-PIECES'],
  'SEEDS-L6':['FND-LEGAL','FND-CHECK','FND-CBR'],'SEEDS-L7':['FND-MATE1','FND-OPENING'],'SEEDS-L8':['FND-TRAPS'],'SEEDS-L9':['FND-OPENING'],'SEEDS-L10':['FND-QK-MATE'],
