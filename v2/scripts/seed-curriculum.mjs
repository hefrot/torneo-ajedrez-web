...
import {seedLessonResources} from '../src/lesson-resources.js';
...
try{
  ...
  const lessonResources=seedLessonResources(db);
  console.log(JSON.stringify({legacy,hmena,mapping,localization,diagnostic,course0800,course1200,diagnostic1200,cisBots,lessonResources}));
}finally{db.close();}
