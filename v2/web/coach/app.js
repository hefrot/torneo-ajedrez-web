...
async function openStudent(studentId){
  activeStudentId=studentId; const [d,nextData,learning,curriculum,ratings,training]=await Promise.all([api(`../api/admin/students/${encodeURIComponent(studentId)}/profile`),api(`../api/admin/students/${encodeURIComponent(studentId)}/next-lesson`),api(`../api/admin/students/${encodeURIComponent(studentId)}/learning-priorities`),api('../api/admin/curriculum/hmena'),api(`../api/admin/students/${encodeURIComponent(studentId)}/rating-progress`),api(`../api/admin/students/${encodeURIComponent(studentId)}/training-intelligence`)]);
