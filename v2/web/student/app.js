...
let locale=localStorage.getItem('hmena_portal_locale')||'en';
const copy={
...
async function loadPortal(){
  ...
  $('#login-panel').hidden=true;$('#portal').hidden=false;$('#logout').hidden=false;
